            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 16, alignItems: 'center', justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                <Space size="small">
                  ...
                  <Tooltip title="Gợi ý thông minh">
                    <Button 
                      icon={<SparklesIcon />}
            ...
            <Row gutter={24}>
              ...
              <Col xs={24} lg={7}>
                <Space direction="vertical" size={16} style={{ width: '100%' }}>
                  ...
                  {/* Có thể bạn quan tâm - Tabbed Content */}
                  <Card 
                      ...
                      items={[
                        ...
                        },
                        {
                          ...
                          children: (
                            <List
                              size="small"
                              dataSource={contentItems.guides}
                              renderItem={(item) => {
                                const getIcon = (iconType) => {
                                  switch(iconType) {
                                    case 'check': return <CheckCircleOutlined />;
                                    case 'play': return <ThunderboltOutlined />;
                                    case 'rocket': return <RiseOutlined />;
                                    default: return <BookOutlined />;
                                  }
                                };
                                return (
